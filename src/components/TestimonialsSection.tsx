...
{
  id: 7,
  text: "تعرفين شنو الجميل هالسنه نبتي كانت ارجع لاصالتي وبنفسي الحقيقيه وسبحان الله المايسترا شدي احس اني في الطريق الصحيح",
  highlight: "الحمدلله والشكر لله 🤲🤍✨💫"
},
{
  id: 8,
  text: "عادي انه القيم تدوده واجد يعني مو عارفه او مصدومه الصدق والله… احس اكون في حاله سكون حقيقي عشان اكتشف",
  highlight: "معفوله انه المساعده تكون قيمه مزروعه وانه التأثير هو قيمه عليا عندي… الصدق اني في حاله من الصدمه الجميله اللي تدوده"
},
{
  id: 9,
  text: "برغم بساطتها للدورة الخامسة مش طويله الا انها دسمه ههههه جد انه مرات بتكون الدسامه باستيعاب المعلومات",
  highlight: "حاسه حابه ارجع اعيدها كلها… فيها اشي عم بوصلي الرسائل فراح اعطيها حقها واضل فيها هههه"
}];


const TestimonialsSection = () => {
  return (
    <section className="relative py-20 bg-lavender overflow-hidden md:py-[80px]">
